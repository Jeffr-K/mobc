...
import { useQueryProfileActivitiesHook } from '@/entities/user/interface/profile.hooks';
import { useProfileActivitiesStore } from '@/entities/user/adapter/profile.atoms';
