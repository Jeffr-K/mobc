...
import { ActionButton, DetailAvatar, DetailCategory, DetailCategoryWrapper, DetailContainer, DetailContent, DetailFollowButton, DetailHeader, DetailMetaSection, DetailMoreButton, DetailProfileBasic, DetailProfileInfo, DetailProfileName, DetailProfileSection, DetailProfileTitle, DetailProfileWrapper, DetailPublishInfo, DetailStatItem, DetailStats, DetailSubCategory, DetailText, ReplyButton, ReplyButtonGroup, ReplyInput, ReplyInputWrapper, ReplyTextField, ReviewActions, ReviewAuthorInfo, ReviewAuthorMeta, ReviewAuthorName, ReviewAuthorTitle, ReviewAvatar, ReviewContent, ReviewDate, ReviewHeader, ReviewInput, ReviewItem, ReviewList, ReviewSection, ReviewSortButton, ReviewTextField, ReviewTitle } from "../x/styles";
import { Eye, Heart, MessageCircle, MoreHorizontal } from "lucide-react";
import { FaChevronDown } from "react-icons/fa";

export function FeedDetail({ feed }: { feed: any }) {
  ...
  return (
    <DetailContainer>
      <DetailHeader>
        ...
        <DetailMetaSection>
          <DetailPublishInfo>
            published Jan 15, 2024, 09:30 AM
          </DetailPublishInfo>
          <DetailStats>
            <DetailStatItem>
              <Eye size={12} />
